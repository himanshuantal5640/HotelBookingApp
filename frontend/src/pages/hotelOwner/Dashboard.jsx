    ...
    <div>
        ...
        <div className='flex gap-5 my-8'>
            ...
            <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                <img src={assets.totalBookingIcon} alt="" className='max-sm:hidden h-10 bg-primary/20 rounded' />
            ...
            {/* total revenue */}
            <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                <img src={assets.totalRevenueIcon} alt="" className='border border-primary/10 bg-primary/20 rounded max-sm:hidden h-10' />
                <div className='flex flex-col sm:ml-4 font-medium'>
