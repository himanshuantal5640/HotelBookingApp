...
const Hero = () => {
  return (
    ...
    bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20 '>The Ulitimate Hotel Experience </p>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base '>Unparalleded luxury and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p>
